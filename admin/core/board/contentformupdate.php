...
if ($w == "" || $w == "u")
{
    ...
    if( $error_msg ){
        alert($error_msg, EYOOM_ADMIN_URL . "/?dir=board&amp;pid=contentform&amp;w=u&amp;co_id=$co_id");
    } else {
        alert($msg, EYOOM_ADMIN_URL . "/?dir=board&amp;pid=contentform&amp;w=u&amp;co_id=$co_id");
    }
}
else
{
    alert($msg, EYOOM_ADMIN_URL . "/?dir=board&amp;contentlist");
}
?>
