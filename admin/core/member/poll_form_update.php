...
if ($w == 'd')
    alert('지정한 투표를 삭제하였습니다.', EYOOM_ADMIN_URL . '/?dir=member&pid=poll_list&'.$qstr);
else
    alert('투표 정보를 업데이트하였습니다.', EYOOM_ADMIN_URL . '/?dir=member&pid=poll_form&w=u&po_id='.$po_id.'&amp;'.$qstr);
?>
