...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$_POST['de_admin_company_owner']}',
                ...
                de_admin_company_addr1        = '{$_POST['de_admin_company_addr1']}',
                de_admin_company_addr2        = '{$_POST['de_admin_company_addr2']}',
                de_admin_company_addr3        = '{$_POST['de_admin_company_addr3']}',
                de_admin_company_addr_jibeon  = '{$_POST['de_admin_company_addr_jibeon']}',
...
alert('쇼핑몰 설정을 적용하였습니다.', EYOOM_ADMIN_URL . "/?dir=shop&amp;pid=configform");
?>
