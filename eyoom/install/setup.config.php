...
<input type="hidden" name="tm_name" id="tm_name" value="basic3">
...
<div class="ins_inner bg_light_grey text-center">
    <p class="margin-bottom-10"><strong>이미 설치된 <?php echo $tm_shop == 'y' ? '영카트5': '그누보드5'; ?>에 <span class="color-red">이윰빌더 시즌3</span>를 추가 설치합니다.</strong></p>
