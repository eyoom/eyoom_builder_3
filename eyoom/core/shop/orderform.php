...
if($is_mobile_order) {
    ...
    require_once(EYOOM_SHOP_PATH.'/orderform.mobile.sub.php');
    
	$tpl->define(array(
		'orderform_sub_bs'	=> 'skin_bs/shop/' . $eyoom['shop_skin'] . '/orderform.mobile.sub.html',
	));
} else {
    $order_action_url = G5_HTTPS_SHOP_URL.'/orderformupdate.php';
    require_once(EYOOM_SHOP_PATH.'/orderform.sub.php');
    
	$tpl->define(array(
		'orderform_sub_bs'	=> 'skin_bs/shop/' . $eyoom['shop_skin'] . '/orderform.sub.html',
	));
}
...
// Template define
$tpl->define_template('shop',$eyoom['shop_skin'],'orderform.skin.html');

// 사용자 프로그램
@include_once(EYOOM_USER_PATH.'/shop/orderform.php');
